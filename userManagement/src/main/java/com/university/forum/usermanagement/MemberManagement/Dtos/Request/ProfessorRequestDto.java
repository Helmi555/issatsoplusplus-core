...
public class ProfessorRequestDto {
    ...
    public ProfessorRequestDto(String firstName, String lastName, String addressEmail, String phoneNumber, String address, String password, String confirmPassword, String linkedInProfileUrl, String profileImageUrl, String cin, Boolean sex, Set<Integer> rolesIds, LocalDate dob, Set<Integer> classGroupIds) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.addressEmail = addressEmail;
        this.phoneNumber = phoneNumber;
